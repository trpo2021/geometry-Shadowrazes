...
vectCoord(std::pair<double, double> start, std::pair<double, double> close);
double
lenLine(std::pair<double, double> start, std::pair<double, double> close);
...
std::vector<std::vector<int>> intersects(
        std::vector<std::pair<std::string, std::vector<double>>> flist,
